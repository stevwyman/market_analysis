    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("open_price", models.DecimalField(decimal_places=4, max_digits=7)),
                ("high_price", models.DecimalField(decimal_places=4, max_digits=7)),
                ("low", models.DecimalField(decimal_places=4, max_digits=7)),
                ("close", models.DecimalField(decimal_places=4, max_digits=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "securities",
                    models.ManyToManyField(
                        related_name="securities", to="data.security"
                    ),
                ),
                (
                    "user",
